...
-- Create products table with external_link column
...
INSERT INTO products (
  name, description, price, quantity, category, details, dimensions, "careInstructions", images, featured, external_link
) VALUES
(
  ...
  true,
  'https://amazon.com/sample-product-1'
),
(
  ...
  true,
  'https://amazon.com/sample-product-2'
);